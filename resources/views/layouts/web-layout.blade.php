        ...
        <footer class="text-gray-400 bg-gray-900 body-font">
            <div class="container px-5 py-24 mx-auto">
              <div class="flex flex-wrap md:text-left text-center order-first">
                <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                  <h2 class="title-font font-medium text-white tracking-widest text-sm mb-3">Pricing</h2>
                  <nav class="list-none mb-10">
                    ...
                    <li>
                      <a class="text-gray-400 hover:text-white">Business</a>
                    </li>
                    <li>
                      <a class="text-gray-400 hover:text-white">Special</a>
                    </li>
                  </nav>
                </div>
                <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                  <h2 class="title-font font-medium text-white tracking-widest text-sm mb-3">RECEIVE NEWS AND UPDATES</h2>
                  <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                    <div class="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                      <label for="footer-field" class="leading-7 text-sm text-gray-400">Enter Your Email</label>
                      <input type="text" id="footer-field" name="footer-field" class="w-full bg-gray-800 rounded border bg-opacity-40 border-gray-700 focus:bg-transparent focus:ring-2 focus:ring-blue-900 focus:border-blue-600 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                    <button class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-blue-900 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Subscribe</button>
                  </div>
                  <p class="text-gray-500 text-sm mt-2 md:text-left text-center">You will receive news and updates regarding our services.
                    <br class="lg:block hidden">We will not spam you with emails.
                  </p>
                </div>
              </div>
            </div>
            <div class="bg-gray-700 bg-opacity-75">
              <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p class="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4">© 2024 Rook —
                  <a href="https://rook.io/" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@Rook</a>
                </p>
